...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-4150188484370903.3.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-4150188484370903.3.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[mlops-demo/databricks.yml](../mlops_demo/databricks.yml) file.
...
Follow the instructions in [mlops-demo/resources/README.md](../mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
