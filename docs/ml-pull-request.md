...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-4150188484370903.3.azuredatabricks.net/explore/data/models/staging/mlops-demo/mlops-demo-model)
* [Prod model in UC](https://adb-4150188484370903.3.azuredatabricks.net/explore/data/models/prod/mlops-demo/mlops-demo-model)
. 
